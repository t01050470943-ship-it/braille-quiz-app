        ...
        clauses: {
          ...
          '제2항': {
            ...
            items: [
              ...
              { char: 'ㄸ', dots: [[6], [2, 4, 5]], name: '쌍디귿' },
              { char: 'ㅃ', dots: [[6], [4, 5]], name: '쌍비읍' },
              { char: 'ㅆ', dots: [[6], [2, 3, 4]], name: '쌍시옷' },
          ...
          '제6항': {
            ...
            items: [
              ...
              { char: 'ㅛ', dots: [3, 4, 6], name: '요' },
              { char: 'ㅜ', dots: [1, 4, 6], name: '우' },
              { char: 'ㅠ', dots: [1, 4, 5], name: '유' },
          ...
          '제7항': {
            ...
            items: [
              ...
              { char: 'ㅘ', dots: [[1, 3, 6], [1, 2, 6]], name: 'ㅗ+ㅏ' },
              { char: 'ㅙ', dots: [[1, 3, 6], [1, 2, 3, 5]], name: 'ㅗ+ㅐ' },
              { char: 'ㅝ', dots: [[1, 4, 6], [2, 3, 4]], name: 'ㅜ+ㅓ' },
              { char: 'ㅞ', dots: [[1, 4, 6], [1, 2, 3, 5]], name: 'ㅜ+ㅔ' },
              { char: 'ㅟ', dots: [[1, 4, 6], [1, 3, 5]], name: 'ㅜ+ㅣ' },
      ...
      '약자': {
        ...
        clauses: {
          ...
          '제17항': {
            ...
            items: [
              { char: '성', dots: [[2, 3, 4], [1, 2, 4, 5, 6]], name: 'ㅅ + 영 약자' },
              { char: '썽', dots: [[6], [2, 3, 4], [1, 2, 4, 5, 6]], name: 'ㅆ + 영 약자' },
